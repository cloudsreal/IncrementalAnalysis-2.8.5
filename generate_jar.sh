...
cp -r alias_analysis alias_data alias_stmt analysis cache_analysis cache_data data ./new_jar
...
mv giraph-examples-1.4.0-SNAPSHOT-shaded.jar giraph-examples-1.4.0-SNAPSHOT-shaded-opt-collect.jar

cp giraph-examples-1.4.0-SNAPSHOT-shaded-opt-collect.jar /Users/zhangyujin/Desktop/Experiment/jar